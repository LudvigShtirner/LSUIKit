public final class LSCollectionView<
    EmptyView: UIView,
    LoadingView: UIView
>: UICollectionView, LSViewInterfaceInternal {
    ...
    // MARK: - Dependencies
    private lazy var dataProvider = LSCollectionViewDataSource(collectionView: self)
...
public extension LSCollectionView {
    func reload(
...
private extension LSCollectionView {
    func setupUI() {
